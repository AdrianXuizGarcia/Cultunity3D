...
public class Lang 
{
    ...
    */
    public void setLanguage ( string path, string language) {
		...
		/* Edit by Adrián Xuíz: 
			- Now the lang.xml file must be on Resources, in order to work on proyect build.
			- Format of path edited to work with the library Resources.
		*/
		path = path.Replace("\\", "/");
